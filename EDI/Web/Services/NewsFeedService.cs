        ...
        public async Task<NewsFeedItemViewModel> GetNewsFeedItem(int newsFeedId)
        {
            ...
            try
            {
                ...
                var vm = new NewsFeedItemViewModel()
                {
                    ...
                    Newfoundland = newsFeed.Newfoundland.HasValue ? newsFeed.Newfoundland.Value : false,
                    ...
                    Pei = newsFeed.Pei.HasValue ? newsFeed.Pei.Value : false,
                    ...
                    Yukon = newsFeed.Yukon.HasValue ? newsFeed.Yukon.Value : false,
                    Nwt = newsFeed.Nwt.HasValue ? newsFeed.Nwt.Value : false,
