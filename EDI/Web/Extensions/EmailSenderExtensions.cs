...
namespace EDI.Web.Extensions
{
    public static class EmailSenderExtensions
    {
        ...
        {            
            ...
            string callbackUrl = "http://localhost:63872/Accounts/ResetPassword/resetpassword";
            ...
            //string htmlString2 = $"<p>Please navigate to <a href='{HtmlEncoder.Default.Encode(link)}'>http://localhost:63872/Accounts/ResetPassword/resetpassword</a> to set your password.</p>";
