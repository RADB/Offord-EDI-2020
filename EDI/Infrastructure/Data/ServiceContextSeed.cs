...
namespace EDI.Infrastructure.Data
{
    public class ServiceContextSeed
    {
            ...
            ILoggerFactory loggerFactory, int? retry = 0)
        {
            ...
            try
            {
                if (!ServiceContext.Currency.Any())
                {
                    ServiceContext.Currency.AddRange(
                        GetPreconfiguredCurrencies());

                    await ServiceContext.SaveChangesAsync();
                }

                if (!ServiceContext.Country.Any())
                {
                    ServiceContext.Country.AddRange(
                ...
                if (!ServiceContext.Province.Any())
                {
                    ...
                    var countryid = ServiceContext.Country.Where(t => t.Name == "Argentina").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Argentina"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Australia").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Australia"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Austria").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Austria"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Belgium").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Belgium"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Brazil").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Brazil"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Bulgaria").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Bulgaria"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Canada").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(provincetypeid, countryid, "Canada"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "China").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "China"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Taiwan, Province of China").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Taiwan, Province of China"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Colombia").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Colombia"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Czech Republic").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Czech Republic"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Denmark").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Denmark"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Finland").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Finland"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "France").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "France"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Germany").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Germany"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Greece").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Greece"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "India").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "India"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Italy").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Italy"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Japan").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Japan"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Korea, Republic of").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Korea, Republic of"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Malaysia").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Malaysia"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Mexico").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Mexico"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Netherlands").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Netherlands"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Norway").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Norway"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Philippines").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Philippines"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Poland").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Poland"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Romania").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Romania"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Spain").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Spain"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Sweden").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Sweden"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Switzerland").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Switzerland"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Thailand").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Thailand"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "Turkey").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "Turkey"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "United Kingdom").Select(t => t.Id).FirstOrDefault();

                    ServiceContext.Province.AddRange(
                        GetPreconfiguredAllProvinces(1, countryid, "United Kingdom"));

                    countryid = ServiceContext.Country.Where(t => t.Name == "United States").Select(t => t.Id).FirstOrDefault();
        ...
        static IEnumerable<Currency> GetPreconfiguredCurrencies()
        {
            ...
            {
                new Currency() { Name = "CAD - Canadian dollar", CreatedBy ="dengb", CreatedDate= DateTime.Now, ModifiedBy = "dengb", ModifiedDate = DateTime.Now},
                new Currency() { Name = "EUR - Euro", CreatedBy ="dengb", CreatedDate= DateTime.Now, ModifiedBy = "dengb", ModifiedDate = DateTime.Now },
                new Currency() { Name = "USD - U.S. dollar", CreatedBy ="dengb", CreatedDate= DateTime.Now, ModifiedBy = "dengb", ModifiedDate = DateTime.Now }
            }.OrderBy(t => t.Name);
        }
