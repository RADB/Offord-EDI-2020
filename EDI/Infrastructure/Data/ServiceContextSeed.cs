...
namespace EDI.Infrastructure.Data
{
    public class ServiceContextSeed
    {
        ...
        static IEnumerable<Questionnaire> GetPreconfiguredQuestionnaires()
        {
            ...
            {
                new Questionnaire() {English="Demographics",QuestionnaireName="Demographics",YearId=1,CreatedBy ="admin", CreatedDate= DateTime.Now, ModifiedBy = "admin", ModifiedDate = DateTime.Now,French="Demographics",DescriptionEnglish="Demographics",DescriptionFrench="Demographics",ShowProgressBar=true,ShowQuestionNumbers=true,IsTeacherQuestionnaire=false,IsChildQuestionnaire=true,Sequence=10},
                new Questionnaire() {English="Section A",QuestionnaireName="Section A",YearId=1,CreatedBy ="admin", CreatedDate= DateTime.Now, ModifiedBy = "admin", ModifiedDate = DateTime.Now,French="Section A",DescriptionEnglish="Section A",DescriptionFrench="Section A",ShowProgressBar=true,ShowQuestionNumbers=true,IsTeacherQuestionnaire=false,IsChildQuestionnaire=true,Sequence=20},
                new Questionnaire() {English="Section B",QuestionnaireName="Section B",YearId=1,CreatedBy ="admin", CreatedDate= DateTime.Now, ModifiedBy = "admin", ModifiedDate = DateTime.Now,French="Section B",DescriptionEnglish="Section B",DescriptionFrench="Section B",ShowProgressBar=true,ShowQuestionNumbers=true,IsTeacherQuestionnaire=false,IsChildQuestionnaire=true,Sequence=30},
                new Questionnaire() {English="Section C",QuestionnaireName="Section C",YearId=1,CreatedBy ="admin", CreatedDate= DateTime.Now, ModifiedBy = "admin", ModifiedDate = DateTime.Now,French="Section C",DescriptionEnglish="Section C",DescriptionFrench="Section C",ShowProgressBar=true,ShowQuestionNumbers=true,IsTeacherQuestionnaire=false,IsChildQuestionnaire=true,Sequence=40},
                new Questionnaire() {English="Section D",QuestionnaireName="Section D",YearId=1,CreatedBy ="admin", CreatedDate= DateTime.Now, ModifiedBy = "admin", ModifiedDate = DateTime.Now,French="Section D",DescriptionEnglish="Section D",DescriptionFrench="Section D",ShowProgressBar=true,ShowQuestionNumbers=true,IsTeacherQuestionnaire=false,IsChildQuestionnaire=true,Sequence=50},
                new Questionnaire() {English="Section E",QuestionnaireName="Section E",YearId=1,CreatedBy ="admin", CreatedDate= DateTime.Now, ModifiedBy = "admin", ModifiedDate = DateTime.Now,French="Section E",DescriptionEnglish="Section E",DescriptionFrench="Section E",ShowProgressBar=true,ShowQuestionNumbers=true,IsTeacherQuestionnaire=false,IsChildQuestionnaire=true,Sequence=60},
                new Questionnaire() {English="Teacher Feedback",QuestionnaireName="Teacher Feedback",YearId=1,CreatedBy ="admin", CreatedDate= DateTime.Now, ModifiedBy = "admin", ModifiedDate = DateTime.Now,French="Teacher Feedback",DescriptionEnglish="Teacher Feedback",DescriptionFrench="Teacher Feedback",ShowProgressBar=true,ShowQuestionNumbers=true,IsTeacherQuestionnaire=true,IsChildQuestionnaire=false,Sequence=10}
            };
        }
    }
}
