        ...
        static IEnumerable<Province> GetPreconfiguredAllProvinces(int provincetypeid, int countryid, string countryName)
        {
            ...
            else if (countryName == "Taiwan, Province of China")
            {
                return new List<Province>()
                {
                    ...
                    new Province() { English = "Taipei", French = "", Code = "TPE", CountryID = countryid, ProvinceTypeId = provincetypeid, CreatedBy ="admin", CreatedDate= DateTime.Now, ModifiedBy = "admin", ModifiedDate = DateTime.Now},
                    new Province() { English = "Taipei", French = "", Code = "TPQ", CountryID = countryid, ProvinceTypeId = provincetypeid, CreatedBy ="admin", CreatedDate= DateTime.Now, ModifiedBy = "admin", ModifiedDate = DateTime.Now},
