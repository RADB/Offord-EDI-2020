...
namespace EDI.Infrastructure.Data.Migrations
{
    public partial class _2023Manitoba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // move Question Up
            migrationBuilder.Sql("UPDATE [EDI].[Questionnaires.Configuration] SET sequence = 90, GroupName = 'Demographics' WHERE id=1929 AND Yearid=3 AND QuestionnaireID=51");
            ...
            //class type
            migrationBuilder.Sql("UPDATE [EDI].[Questionnaires.Configuration] SET LookupEntityID=124 WHERE id=1914 AND Yearid=3 AND QuestionnaireID=51");
            //language status
            migrationBuilder.Sql("UPDATE [EDI].[Questionnaires.Configuration] SET English='English/French as Additional Language:',French='English/French as Additional Language:',LookupEntityId=125 WHERE id=1917 AND Yearid=3 AND QuestionnaireID=51");
            //Indigenous
            migrationBuilder.Sql("UPDATE [EDI].[Questionnaires.Configuration] SET English='Indigenous (First Nations, Metis, or Inuit):',French='Indigenous (First Nations, Metis, or Inuit):',LookupEntityId=78,VariableName='IndigenousAncestry',EntityField='IndigenousAncestry' WHERE id=1928 AND Yearid=3 AND QuestionnaireID=51");
            ...
            //insert options
            migrationBuilder.Sql("INSERT INTO [EDI].[Questionnaires.Configuration]([QuestionnaireID],[InputTypeId],[OrientationID] ,[IsHeader] ,[ShowGroupName] ,[GroupName],[IsCollapsible],[min],[max],[numberstep],[Label],[English],[French],[VariableName],[HasLookupEntity],[LookupEntity],[LookupEntityID],[Sequence],[Columns],[ColumnSpan],[QuestionNumber],HasHelp,HelpTextEnglish,HelpTextFrench,IsRequired,HasNotification,NotificationCondition,[Notification],NotificationFrench,EntityName,EntityField,YearId,[NewfoundlandandLabrador]) VALUES(52,34,5,0,0,'NonParental2',0,Null,Null,Null,'Null','Centre-based, licensed, non-profit','Centre-based, licensed, non-profit','CentreBasedLicensedNonProfit',0,'Null',Null,110,1,1,'Null' ,0,'','',1,0,'Null','','','Questionnaires.Data.SectionE','CentreBasedLicensedNonProfit' ,3,1)");
            migrationBuilder.Sql("INSERT INTO [EDI].[Questionnaires.Configuration]([QuestionnaireID],[InputTypeId],[OrientationID] ,[IsHeader] ,[ShowGroupName] ,[GroupName],[IsCollapsible],[min],[max],[numberstep],[Label],[English],[French],[VariableName],[HasLookupEntity],[LookupEntity],[LookupEntityID],[Sequence],[Columns],[ColumnSpan],[QuestionNumber],HasHelp,HelpTextEnglish,HelpTextFrench,IsRequired,HasNotification,NotificationCondition,[Notification],NotificationFrench,EntityName,EntityField,YearId,[NewfoundlandandLabrador]) VALUES(52,34,5,0,0,'NonParental2',0,Null,Null,Null,'Null','Centre-based, licensed, for profit','Centre-based, licensed, for profit','CentreBasedLicensedProfit',0,'Null',Null,120,1,1,'Null' ,0,'','',1,0,'Null','','','Questionnaires.Data.SectionE','CentreBasedLicensedProfit' ,3,1)");
            migrationBuilder.Sql("INSERT INTO [EDI].[Questionnaires.Configuration]([QuestionnaireID],[InputTypeId],[OrientationID] ,[IsHeader] ,[ShowGroupName] ,[GroupName],[IsCollapsible],[min],[max],[numberstep],[Label],[English],[French],[VariableName],[HasLookupEntity],[LookupEntity],[LookupEntityID],[Sequence],[Columns],[ColumnSpan],[QuestionNumber],HasHelp,HelpTextEnglish,HelpTextFrench,IsRequired,HasNotification,NotificationCondition,[Notification],NotificationFrench,EntityName,EntityField,YearId,[NewfoundlandandLabrador]) VALUES(52,34,5,0,0,'NonParental2',0,Null,Null,Null,'Null','Other home-based, licensed','Other home-based, licensed','OtherHomeLicensed',0,'Null',Null,130,1,1,'Null' ,0,'','',1,0,'Null','','','Questionnaires.Data.SectionE','OtherHomeLicensed' ,3,1)");
            migrationBuilder.Sql("INSERT INTO [EDI].[Questionnaires.Configuration]([QuestionnaireID],[InputTypeId],[OrientationID] ,[IsHeader] ,[ShowGroupName] ,[GroupName],[IsCollapsible],[min],[max],[numberstep],[Label],[English],[French],[VariableName],[HasLookupEntity],[LookupEntity],[LookupEntityID],[Sequence],[Columns],[ColumnSpan],[QuestionNumber],HasHelp,HelpTextEnglish,HelpTextFrench,IsRequired,HasNotification,NotificationCondition,[Notification],NotificationFrench,EntityName,EntityField,YearId,[NewfoundlandandLabrador]) VALUES(52,34,5,0,0,'NonParental2',0,Null,Null,Null,'Null','Other home-based, unlicensed, non-relative','Other home-based, unlicensed, non-relative','OtherHomeUnlicensedNonRelative',0,'Null',Null,140,1,1,'Null' ,0,'','',1,0,'Null','','','Questionnaires.Data.SectionE','OtherHomeUnlicensedNonRelative' ,3,1)");
            migrationBuilder.Sql("INSERT INTO [EDI].[Questionnaires.Configuration]([QuestionnaireID],[InputTypeId],[OrientationID] ,[IsHeader] ,[ShowGroupName] ,[GroupName],[IsCollapsible],[min],[max],[numberstep],[Label],[English],[French],[VariableName],[HasLookupEntity],[LookupEntity],[LookupEntityID],[Sequence],[Columns],[ColumnSpan],[QuestionNumber],HasHelp,HelpTextEnglish,HelpTextFrench,IsRequired,HasNotification,NotificationCondition,[Notification],NotificationFrench,EntityName,EntityField,YearId,[NewfoundlandandLabrador]) VALUES(52,34,5,0,0,'NonParental2',0,Null,Null,Null,'Null','Other home-based, unlicensed, relative','Other home-based, unlicensed, relative','OtherHomeUnlicensedRelative',0,'Null',Null,150,1,1,'Null' ,0,'','',1,0,'Null','','','Questionnaires.Data.SectionE','OtherHomeUnlicensedRelative' ,3,1)");
