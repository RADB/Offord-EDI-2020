    ...
    public partial class _2023NewFoundLand : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            values: new object[,]
            {
                    ...
                    { 974, "admin", new DateTime(2022, 12, 21, 13, 56, 34, 119, DateTimeKind.Local).AddTicks(8400), "French Immersion", "French Immersion", 122, "admin", new DateTime(2022, 12, 21, 13, 56, 34, 119, DateTimeKind.Local).AddTicks(8402), (short)10, (short)1, 3 },
                    { 975, "admin", new DateTime(2022, 12, 21, 13, 56, 34, 119, DateTimeKind.Local).AddTicks(8404), "Other Immersion", "Other Immersion", 122, "admin", new DateTime(2022, 12, 21, 13, 56, 34, 119, DateTimeKind.Local).AddTicks(8405), (short)20, (short)2, 3 },
                    { 976, "admin", new DateTime(2022, 12, 21, 13, 56, 34, 119, DateTimeKind.Local).AddTicks(8407), "No", "Non", 122, "admin", new DateTime(2022, 12, 21, 13, 56, 34, 119, DateTimeKind.Local).AddTicks(8408), (short)30, (short)3, 3 }
            });
