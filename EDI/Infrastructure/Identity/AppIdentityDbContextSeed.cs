...
namespace EDI.Infrastructure.Identity
{
    public class AppIdentityDbContextSeed
    {
        public static async Task SeedAsync(UserManager<EDIApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            await CreateUserAsync(userManager, "aofford@mcmaster.ca", "EDI&ict2020", "Administrator");
            await CreateUserAsync(userManager, "agaskin@mcmaster.ca", "EDI&ict2020", "Administrator");
        }
